                ...
                {updatebook?.map((book, index) => {
                    return (
                        <div key={index} className=" block md:flex border-[1px] p-5 mt-5">
                            <div className="flex  " >
                                <div><Image src={`https://doctor-appointment-12ox.onrender.com${book?.doctor?.image[0]?.url}`} width={200} height={200} alt="photo" className="rounded-full w-[180px] md:w-[200px] h-[150px] mr-30" /></div>
